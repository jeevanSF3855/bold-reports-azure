    ...
    "tr-TR": {
        "boldReportViewer": {
            toolbar: {
                ...
                limitrecordsetup: {
                    headerText: 'Kayıt Limiti Kurulumu',
                    contentText: 'Kayıt Sınırını ayarlamak için Kayıt sınırlama ayarını seçin.',
                    recordCount: 'Kayıt sayısı',
                    limitRecordWarningMessage: 'Rapor şu anda {record count} kaydı gösteriyor. Verilerin tamamını görüntülemek için lütfen aralıktaki aralığı ayarlayın.',
                    limitRecordLoadFullDataMessage: 'Rapor kısmi kayıtlarla oluşturulmuştur. Verilerin tamamını yüklemek için tıklayın',
                    loadFullData: 'Tüm verileri yükle',
                    limitrecordsetup: 'Kayıt ayarlarını sınırla'
                },
                performance: {
            ...
            exportsetupDialog: {
                ...
                wordOptions: {
                    ...
                    formatList: [
                        { text: "Word Belgesi (.doc)", value: 0 },
                        { text: "Word Şablonu (.dot)", value: 1 },
                        { text: "Word belgesi (.docx)", value: 2 },
                        { text: "Word Şablonu (.dotx)", value: 8 },
                ...
                pptOptions: {
                    ...
                    pptTypes: [
                        { text: "Priz (.ppt)", value: 0 },
                        { text: "Priz (.pptx)", value: 3 }
                    ]
                },
                dpi: 'dpi',
                doneButton: 'tamam',
                ...
                excelOptions:
                {
                    ...
                    readonly: 'Sadece oku',
                    includeRawData: "Genç ham veriler",
                    saveTypes: [
                        { text: "Excel Çalışma Kitabı(.xls)", value: 0 },
                        { text: "Excel Çalışma Kitabı(.xlsx)", value: 4 }],
            ...
            progressMessage: {
                ...
                reportLoadingMessage: 'Rapportutskrift ...',
                cancelText: 'iptal etmek',
                creatingTheDocumentMessage: "Belgeyi oluşturma"
            },
            alertMessage: {
                close: 'Kapat',
                title: 'ReportViewer',
