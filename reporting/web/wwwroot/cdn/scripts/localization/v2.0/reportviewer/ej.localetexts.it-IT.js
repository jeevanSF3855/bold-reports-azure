    ...
    "it-IT": {
        "boldReportViewer": {
            toolbar: {
                ...
                printLayout: {
                    headerText: "Anteprima di stampa",
                ...
                limitrecordsetup: {
                    headerText: 'Impostazione del limite di registrazione',
                    contentText: "Scegli l'opzione di configurazione Limita registrazione per impostare il limite di registrazione.",
                    recordCount: 'Conteggio registrazioni',
                    limitRecordWarningMessage: "Il report attualmente visualizza {recordcount} record. Per visualizzare i dati completi, modificare l'intervallo nel",
                    limitRecordLoadFullDataMessage: 'Il report è stato generato con record parziali. Per caricare i dati completi, fare clic su',
                    loadFullData: 'Carica i dati completi',
                    limitrecordsetup: 'Limita le impostazioni di registrazione'
                },
                performance: {
            ...
            exportsetupDialog: {
                ...
                wordOptions: {
                    ...
                    formatList: [
                        { text: "Documento Word (.doc)", value: 0 },
                        { text: "Modello Word (.dot)", value: 1 },
                        { text: "Documento Word (.docx)", value: 2 },
                        { text: "Modello Word (.dotx)", value: 8 },
                ...
                excelOptions:
                {
                    ...
                    includeRawData: "Dati grezzi giovani",
                    saveTypes: [
                        { text: "Cartella di lavoro Excel (.xls)", value: 0 },
                        { text: "Cartella di lavoro Excel (.xlsx)", value: 4 }],
            ...
            progressMessage: {
                exportLoadingMessage: 'Esportazione rapporto ...',
                ...
                reportLoadingMessage: 'Elaborazione dei rapporti ...',
                cancelText: 'Annulla',
                creatingTheDocumentMessage: "Creazione del documento"
            },
            alertMessage: {
                close: 'Vicino',
                title: 'ReportViewer',
