    ...
    "de-DE": {
        "boldReportViewer": {
            toolbar: {
                ...
                limitrecordsetup: {
                    headerText: 'Aufnahmelimit-Setup',
                    contentText: 'Wählen Sie die Setup-Option „Datensatz begrenzen“, um das Datensatzlimit festzulegen.',
                    recordCount: 'Datensatzanzahl',
                    ...
                    limitRecordLoadFullDataMessage: 'Der Bericht wurde mit Teildatensätzen erstellt. Um die vollständigen Daten zu laden, klicken Sie auf',
                    loadFullData: 'Vollständige Daten laden',
                    limitrecordsetup: 'Beschränken Sie die Aufnahmeeinstellungen'
                },
                performance: {
            ...
            exportsetupDialog: {
                ...
                wordOptions: {
                    ...
                    formatList: [
                        { text: "Word-Datei (.doc)", value: 0 },
                        { text: "Word Template (.dot)", value: 1 },
                        { text: "Word-Datei (.docx)", value: 2 },
                        { text: "Word Template (.dotx)", value: 8 },
                ...
                excelOptions:
                {
                    ...
                    saveTypes: [
                        { text: "Excel-Arbeitsmappe (.xls)", value: 0 },
                        { text: "Excel-Arbeitsmappe (.xlsx) ", value: 4 }
                    ],
            ...
            progressMessage: {
                exportLoadingMessage: 'Exportieren von Berichten ...',
                printLoadingMessage: 'Berichtsdruck ...',
                ...
                reportLoadingMessage: 'Berichtsverarbeitung',
                cancelText: 'stornieren',
                creatingTheDocumentMessage: "Erstellen des Dokuments"
            },
            alertMessage: {
                close: 'Schließen',
