    ...
    "zh-CN": {
        "boldReportViewer": {
            toolbar: {
                ...
                limitrecordsetup: {
                    headerText: '记录限制设置',
                    contentText: '选择限制记录设置选项来设置记录限制。',
                    recordCount: '记录数',
                    limitRecordWarningMessage: '该报告当前显示 {record count} 条记录。要查看完整数据，请调整范围',
                    limitRecordLoadFullDataMessage: '已生成包含部分记录的报告。要加载完整数据，请单击',
                    loadFullData: '加载完整数据',
                    limitrecordsetup: '限制记录设置'
                },
                performance: {
                    headerText: '性能指标',
            ...
            exportsetupDialog: {
                ...
                wordOptions: {
                    ...
                    bottomSpacing: '底部间距',
                    formatList: [
                        { text: "Word 文档 (.doc)", value: 0 },
                        { text: "Word 模板 (.dot)", value: 1 },
                        { text: "Word 文档 (.docx)", value: 2 },
                        { text: "Word 模板 (.dotx)", value: 8 },
                ...
                pptOptions: {
                    header: "微软幻灯片软件 环境",
                    pptTypes: [
                        { text: "微软幻灯片软件 (.pptx)", value: 0 },
                        { text: "微软幻灯片软件 (.pptx)", value: 3 }
                    ]
                },
                dpi: 'dpi',
                doneButton: '好',
                ...
                excelOptions:
                {
                    ...
                    readonly: '只讀',
                    includeRawData: "年轻的原始数据",
                    saveTypes: [
                        { text: "Excel 工作簿(.xls)", value: 0 },
                        { text: "Excel 工作簿(.xlsx)", value: 4 }],
