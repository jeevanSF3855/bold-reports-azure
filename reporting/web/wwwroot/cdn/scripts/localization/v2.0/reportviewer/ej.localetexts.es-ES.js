    ...
    "es-ES": {
        "boldReportViewer": {
            toolbar: {
                ...
                printLayout: {
                    headerText: "Vista previa de impresión",
                ...
                fittopage: {
                    ...
                    fitPage: 'La página de ajuste',
                    fitWidth: 'Ajuste ancho'
                },
                pagesetup: {
                ...
                limitrecordsetup: {
                    headerText: 'Configuración del límite de registro',
                    contentText: 'Elija la opción de configuración de registro límite para establecer el límite de registro.',
                    recordCount: 'Número de registros',
                    limitRecordWarningMessage: 'El informe actualmente muestra {recordcount} registros. Para ver los datos completos, ajuste el rango en el',
                    limitRecordLoadFullDataMessage: 'El informe ha sido generado con registros parciales. Para cargar los datos completos, haga clic',
                    loadFullData: 'Cargar datos completos',
                    limitrecordsetup: 'Limitar la configuración de grabación'
                },
                performance: {
            ...
            exportsetupDialog: {
                ...
                commonOptions: {
                    ...
                    usePrintSizes: 'Usar configuración de página de impresión'
                },
                pdfOptions: {
                ...
                wordOptions: {
                    ...
                    formatList: [
                        { text: "Documento de Word (.doc)", value: 0 },
                ...
                excelOptions:
                {
                    ...
                    includeRawData: "Datos jóvenes en bruto",
                    saveTypes: [
                        { text: "Libro de Excel (.xls)", value: 0 },
                        { text: "Libro de Excel (.xlsx) ", value: 4 }
                    ],
            ...
            progressMessage: {
                exportLoadingMessage: 'Exportación de informes ...',
                printLoadingMessage: 'Impresión de informes ...',
                ...
                reportLoadingMessage: 'Procesamiento de informes...',
                cancelText: 'cancelar',
                creatingTheDocumentMessage: "Creando el documento"
            },
            alertMessage: {
                close: "Cerca",
